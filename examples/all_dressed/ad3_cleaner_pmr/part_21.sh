...
s5cmd cp s3://ai2-llm/pretraining-data/sources/cc_all_dressed/all_dressed_v3/minhash/param_26_11/working/clean/* /mnt/raid0/working/clean/
...
git pull
cargo run --release -- clean-files --config examples/all_dressed/all_dressed_v3_1x_2611.yaml > "/mnt/raid0/logs/clean_${X}.log"


s5cmd cp -sp /mnt/raid0/output/ s3://ai2-llm/pretraining-data/sources/cc_all_dressed/all_dressed_v3/minhash/param_26_11/annotated/
